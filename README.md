...
2. Store the game state as 2d array of Boardspaces - an object containing contents and a locator, the locator being the Playwright locator for that square, and the contents is a string:
...
- 'bk' for blue king
- 'ok' for orange king
- '(o)' for selected orange man
- '(ok)' for selected orange king

3. Make moves to generate the scenarios required to test, refresh game state array after each click to ensure proper state changes.
...
#### Scenario 2: Select pieces
Player should be able select and deselect orange pieces
...
#### Scenario 3: First move
Player should be able to make the first move with a legal piece

Test steps:
1. Click on orange man -> Assert: piece highlights
2. Click unoccupied diagonally adjacent space (valid) -> Assert: orange man moves to selected space and initial space is empty. Comp takes turn.

#### Scenario 4: Man can jump opponent
...
#### Scenario 5: Man can be kinged and move down the gameboard
...
#### Scenario 6: Kinged piece can jump opponents down the gameboard
...
#### Scenario 7: Gameboard can be reset at any time
...
#### Scenario 8: Player cannot highlight blue pieces.
...
#### Scenario 9: Man can only move up gameboard
...
#### Scenario 10: Man can only jump opponent's piece
...
#### Scenario 11: Player cannot move orange pieces vertically.
...
#### Scenario 12: Player cannot move orange pieces horizontally.
...
#### Scenario 13: Player cannot move to invalid spaces multiple spaces away.
...
#### Scenario 14: Man can jump 2 opponent pieces
...
#### Scenario 15: Man can optionally choose not to double jump.
...
### Endgame scenarios
#### Scenario 16: Player wins if all opponent's pieces are removed from the board.
...
#### Scenario 17: Player loses if all players's pieces are removed from the board.
...
#### Scenario 18: Player wins if all opponent's pieces can no longer make legal moves.
